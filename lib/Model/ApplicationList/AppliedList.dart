...
ApplicationListString applicationListStringFromJson(String str) => ApplicationListString.fromJson(json.decode(str));

String applicationListStringToJson(ApplicationListString data) => json.encode(data.toJson());

class ApplicationListString {
  ...
  factory ApplicationListString.fromJson(Map<String, dynamic> json) => ApplicationListString(
    error: json["error"],
    msg: json["msg"],
  );
